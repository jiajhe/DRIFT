...
\begin{center}
\textbf{Paper ID: 367}\\
Primary Topic: ML: Graph-based Machine Learning\\
Secondary Topic: ML: Time-Series \& Data Streams
\end{center}
...
% TODO: Motivate the problem, identify the gap, and summarize the contributions.

\section{Related Work}
% TODO: Position DRIFT relative to stock forecasting, graph learning, and temporal modeling.

\section{Method}
% TODO: Define the forecasting setup, directed operator, persistent flow state,
% and the separation of fast transmission intensity from slow direction dynamics.

\section{Experiments}
% TODO: Describe datasets, baselines, evaluation protocol, main results, ablations,
% robustness, and reproducibility details.

\section{Conclusion}
% TODO: Summarize the supported findings without introducing new claims.
